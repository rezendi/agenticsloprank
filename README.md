...
### Nvidia LLM API Tweak

If using the free Nvidia LLM API rather than OpenAI's, edit [seed.yaml](./missions/management/seed.yaml) and replace `gpt-4o` with `nvidia/llama-3.1-nemotron-70b-instruct`
...
- Optionally run `pytest` (confirm the install is working)
